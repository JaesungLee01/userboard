...
<%
	...
	if(request.getParameter("localName") == null						// 요청값 localName이 null이거나 공백이면
		...
		response.sendRedirect(request.getContextPath()+"/board/insertCategoryForm.jsp");// insertLocalForm으로
		return;
	}
	// 요청값 변수에 저장
	...
	// 위 sql 디버깅
	System.out.println(insertLocalStmt + " <-- insertCategoryAction insertLocalStmt");
