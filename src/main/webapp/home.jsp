			...
			<div class="row">
				<div class="offcanvas offcanvas-start text-bg-dark" id="local">
				  ...
				  <div class="offcanvas-body">
					<p class="text-end"><a href="<%=request.getContextPath()%>/board/categoryList.jsp">카테고리 편집</a></p>
					<%
					...
					%>
						...
						<div class="card" style="width:300px">
						  <div class="card-body">
						    ...
						    <a href="<%=request.getContextPath()%>/member/imformationForm.jsp" class="btn btn-dark">회원정보</a>
